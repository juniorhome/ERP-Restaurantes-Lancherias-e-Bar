...
type
  ...
  TProdutoVO = class(TInterfacedObject, IBaseVO<TProdutoVO>)
    ...
    public
      ...
      [TCampoTexto('BARRAS', 'Cód. Barras', 'Cód. Barras', '', 13, False)]
      ...
      [TCampoExtended('CRITICO', 'Crítico', 'Críticos', '#000.00000,000', 15, 3)]
      property Critico: double read FCritico write FCritico;
      [TCampoExtended('PRECO_CUSTO', 'Preço Custo', 'Preços Custos', 'R$#00.0000,00', 15, 2)]
      [TCampoMonetario(True)]
      property PrecoCusto: currency read FPreco_Custo write FPreco_Custo;
      [TCampoExtended('PRECO_VENDA', 'Preço Venda', 'Preços Vendas', 'R$#00.0000,00', 15, 2)]
      [TCampoMonetario(True)]
      ...
      [TCampoTexto('NUM_LOTE', 'Número Lote', 'Números Lotes', '', 20, False)]
