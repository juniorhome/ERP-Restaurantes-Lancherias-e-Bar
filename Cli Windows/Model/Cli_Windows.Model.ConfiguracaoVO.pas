...
type
  ...
  TConfiguracaoVO = class(TInterfacedObject, IBaseVO<TConfiguracaoVO>)
    ...
    public
      ...
      [TCampoTexto('INSTRUCAO_1', 'Intrução 1', 'Instruções 1', '', 100, False)]
      property Intrucao1: string read FInstrucao_1 write FInstrucao_1;
      [TCampoTexto('INSTRUCAO_2', 'Instrução 2', 'Instruções 2', '', 100, False)]
      ...
      [TGridCadastro('RAZAO_SOCIAL', 'Razão Social', 'Razões Sociais', 50)]
      [TGridConsulta('RAZAO_SOCIAL', 'Razão Social', 'Razões Sociais', 50)]
