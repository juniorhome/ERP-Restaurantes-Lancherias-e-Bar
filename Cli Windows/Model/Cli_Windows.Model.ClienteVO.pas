...
type
  ...
  TClienteVO = class(TInterfacedObject, IBaseVO<TClienteVO>)
    ...
    public
      ...
      [TCampoTexto('RESTRICAO', 'Restrição', 'Restrições', '', 1, False)]
      ...
      [TCampoTexto('EHCLIENTE', 'É Cliente', 'São Clientes', '', 1, False)]
      ...
      [TGridCadastro('ENDERECO', 'Endereço', 'Endereços', 35)]
      [TGridConsulta('ENDERECO', 'Endereço', 'Endereços', 35)]
