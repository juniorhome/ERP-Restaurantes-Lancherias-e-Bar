...
begin
   ...
   begin
     ...
     begin
       ...
       TSessaoUsuario.EscreverIni(UsuarioVO.Id, UsuarioVO.Login, UsuarioVO.Foto, chkLembrar.Checked);
     end
     else
       ShowMessage('Usuário não cadastrado.');
   end
   else raise Exception.Create('Usuário ou Senha está vazio ou ambos.');
